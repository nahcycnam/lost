...
def LostAndFound():
	...
	if selected_card == "身份证":
		...
		time.sleep(0.4)
		pyperclip.copy(
			"""javascript:(function(){const e=document.querySelector('iframe[src*="PickUpDetail"]');const t=()=>{const o=e.contentDocument||e.contentWindow.document;(c=o.getElementById("Content_pickupcategory_5"))&&(c.checked=!0,c.dispatchEvent(new Event("change",{bubbles:!0}))),(a=o.getElementById("Content_pickupitem"))&&(a.value="身份证一张，姓名：XXX，身份号码：XXX",a.dispatchEvent(new Event("input",{bubbles:!0})))};e.onload=t,e.contentDocument?.readyState==="complete"&&t()})()""")
		pyautogui.hotkey('ctrl', 'v')
		pyautogui.hotkey('enter')
		time.sleep(0.3)
		pyautogui.hotkey('ctrl', 'shift', 'j')
